...
public class ServerFacade {
    ...
    private final Status status21 = new Status("Hello World 21", "@user1", "google.com", "Feb. 2, 2021 1:00", user2);
    private final Status status22 = new Status("Hello World 22", "@user2", "google.com", "Feb. 2, 2021 2:00", user3);
    private final Status status23 = new Status("Hello World 23", "@user3", "google.com", "Feb. 2, 2021 3:00", user4);
    private final Status status24 = new Status("Hello World 24", "@user4", "google.com", "Feb. 2, 2021 4:00", user5);
    private final Status status25 = new Status("Hello World 25", "@user5", "google.com", "Feb. 2, 2021 5:00", user6);
    private final Status status26 = new Status("Hello World 26", "@user6", "google.com", "Feb. 2, 2021 6:00", user7);
    private final Status status27 = new Status("Hello World 27", "@user7", "google.com", "Feb. 2, 2021 7:00", user8);
    private final Status status28 = new Status("Hello World 28", "@user8", "google.com", "Feb. 2, 2021 8:00", user9);
    private final Status status29 = new Status("Hello World 29", "@user9", "google.com", "Feb. 2, 2021 9:00", user10);
    private final Status status30 = new Status("Hello World 30", "@user10", "google.com", "Feb. 2, 2021 10:00", user11);
    private final Status status31 = new Status("Hello World 31", "@user11", "google.com", "Feb. 2, 2021 11:00", user12);
    private final Status status32 = new Status("Hello World 32", "@user12", "google.com", "Feb. 2, 2021 12:00", user13);
    private final Status status33 = new Status("Hello World 33", "@user13", "google.com", "Feb. 2, 2021 13:00", user14);
    private final Status status34 = new Status("Hello World 34", "@user14", "google.com", "Feb. 2, 2021 14:00", user15);
    private final Status status35 = new Status("Hello World 35", "@user15", "google.com", "Feb. 2, 2021 15:00", user16);
    private final Status status36 = new Status("Hello World 36", "@user16", "google.com", "Feb. 2, 2021 16:00", user17);
    private final Status status37 = new Status("Hello World 37", "@user17", "google.com", "Feb. 2, 2021 17:00", user18);
    private final Status status38 = new Status("Hello World 38", "@user18", "google.com", "Feb. 2, 2021 18:00", user19);
    private final Status status39 = new Status("Hello World 39", "@user19", "google.com", "Feb. 2, 2021 19:00", user20);
    private final Status status40 = new Status("Hello World 40", "@user20", "google.com", "Feb. 2, 2021 20:00", user20);
